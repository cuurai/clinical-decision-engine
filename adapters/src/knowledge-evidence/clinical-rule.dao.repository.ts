...
export class DaoClinicalRuleRepository implements ClinicalRuleRepository {
  ...
  async create(orgId: OrgId, data: ClinicalRuleInput, createdBy?: string): Promise<Timestamps> {
    try {
  ...
  async update(orgId: OrgId, id: string, data: ClinicalRuleUpdate, updatedBy?: string): Promise<Timestamps> {
    try {
  ...
  async createMany(orgId: OrgId, items: Array<ClinicalRuleInput>): Promise<Timestamps[]> {
    try {
  ...
  async updateMany(orgId: OrgId, updates: Array<{ id: string; data: ClinicalRuleUpdate }>): Promise<Timestamps[]> {
    try {
