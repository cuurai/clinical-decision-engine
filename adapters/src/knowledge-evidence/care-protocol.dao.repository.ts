...
export class DaoCareProtocolRepository implements CareProtocolRepository {
  ...
  async create(orgId: OrgId, data: CareProtocolTemplateInput, createdBy?: string): Promise<Timestamps> {
    try {
  ...
  async update(orgId: OrgId, id: string, data: CareProtocolTemplateUpdate, updatedBy?: string): Promise<Timestamps> {
    try {
  ...
  async createMany(orgId: OrgId, items: Array<CareProtocolTemplateInput>): Promise<Timestamps[]> {
    try {
  ...
  async updateMany(orgId: OrgId, updates: Array<{ id: string; data: CareProtocolTemplateUpdate }>): Promise<Timestamps[]> {
    try {
