...
export class DaoRuleSetRepository implements RuleSetRepository {
  ...
  async create(orgId: OrgId, data: RuleSetInput, createdBy?: string): Promise<Timestamps> {
    try {
  ...
  async update(orgId: OrgId, id: string, data: RuleSetUpdate, updatedBy?: string): Promise<Timestamps> {
    try {
  ...
  async createMany(orgId: OrgId, items: Array<RuleSetInput>): Promise<Timestamps[]> {
    try {
      // Use createMany for better performance
      await this.dao.ruleSet.createMany({
        data: items.map(item => ({
          ...item,
          orgId,
        })),
  ...
  async updateMany(orgId: OrgId, updates: Array<{ id: string; data: RuleSetUpdate }>): Promise<Timestamps[]> {
    try {
