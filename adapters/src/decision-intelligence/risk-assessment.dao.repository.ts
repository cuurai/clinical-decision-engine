...
export class DaoRiskAssessmentRepository implements RiskAssessmentRepository {
  ...
  async create(orgId: OrgId, data: RiskAssessmentInput, createdBy?: string): Promise<Timestamps> {
    try {
  ...
  async update(orgId: OrgId, id: string, data: RiskAssessmentUpdate, updatedBy?: string): Promise<Timestamps> {
    try {
  ...
  async createMany(orgId: OrgId, items: Array<RiskAssessmentInput>): Promise<Timestamps[]> {
    try {
  ...
  async updateMany(orgId: OrgId, updates: Array<{ id: string; data: RiskAssessmentUpdate }>): Promise<Timestamps[]> {
    try {
