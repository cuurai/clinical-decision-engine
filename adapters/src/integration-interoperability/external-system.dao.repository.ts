...
export class DaoExternalSystemRepository implements ExternalSystemRepository {
  ...
  async create(orgId: OrgId, data: ExternalSystemInput, createdBy?: string): Promise<Timestamps> {
    try {
  ...
  async update(orgId: OrgId, id: string, data: ExternalSystemUpdate, updatedBy?: string): Promise<Timestamps> {
    try {
  ...
  async createMany(orgId: OrgId, items: Array<ExternalSystemInput>): Promise<Timestamps[]> {
    try {
  ...
  async updateMany(orgId: OrgId, updates: Array<{ id: string; data: ExternalSystemUpdate }>): Promise<Timestamps[]> {
    try {
