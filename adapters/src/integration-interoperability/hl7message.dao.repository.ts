...
export class DaoHL7MessageRepository implements HL7MessageRepository {
  ...
  async create(orgId: OrgId, data: HL7MessageInput, createdBy?: string): Promise<Timestamps> {
    try {
  ...
  async createMany(orgId: OrgId, items: Array<HL7MessageInput>): Promise<Timestamps[]> {
    try {
