...
export class DaoTaskRepository implements TaskRepository {
  ...
  async create(orgId: OrgId, data: TaskInput, createdBy?: string): Promise<Timestamps> {
    try {
  ...
  async update(orgId: OrgId, id: string, data: TaskUpdate, updatedBy?: string): Promise<Timestamps> {
    try {
  ...
  async createMany(orgId: OrgId, items: Array<TaskInput>): Promise<Timestamps[]> {
    try {
  ...
  async updateMany(orgId: OrgId, updates: Array<{ id: string; data: TaskUpdate }>): Promise<Timestamps[]> {
    try {
