...
export class DaoEscalationPolicyRepository implements EscalationPolicyRepository {
  ...
  async create(orgId: OrgId, data: EscalationPolicyInput, createdBy?: string): Promise<Timestamps> {
    try {
  ...
  async update(orgId: OrgId, id: string, data: EscalationPolicyUpdate, updatedBy?: string): Promise<Timestamps> {
    try {
  ...
  async createMany(orgId: OrgId, items: Array<EscalationPolicyInput>): Promise<Timestamps[]> {
    try {
  ...
  async updateMany(orgId: OrgId, updates: Array<{ id: string; data: EscalationPolicyUpdate }>): Promise<Timestamps[]> {
    try {
