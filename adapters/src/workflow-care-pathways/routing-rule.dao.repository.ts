...
export class DaoRoutingRuleRepository implements RoutingRuleRepository {
  ...
  async create(orgId: OrgId, data: RoutingRuleInput, createdBy?: string): Promise<Timestamps> {
    try {
  ...
  async update(orgId: OrgId, id: string, data: RoutingRuleUpdate, updatedBy?: string): Promise<Timestamps> {
    try {
  ...
  async createMany(orgId: OrgId, items: Array<RoutingRuleInput>): Promise<Timestamps[]> {
    try {
  ...
  async updateMany(orgId: OrgId, updates: Array<{ id: string; data: RoutingRuleUpdate }>): Promise<Timestamps[]> {
    try {
