...
export class DaoObservationRepository implements ObservationRepository {
  ...
  async create(orgId: OrgId, data: ObservationInput, createdBy?: string): Promise<Timestamps> {
    try {
  ...
  async update(orgId: OrgId, id: string, data: ObservationUpdate, updatedBy?: string): Promise<Timestamps> {
    try {
  ...
  async createMany(orgId: OrgId, items: Array<ObservationInput>): Promise<Timestamps[]> {
    try {
  ...
  async updateMany(orgId: OrgId, updates: Array<{ id: string; data: ObservationUpdate }>): Promise<Timestamps[]> {
    try {
