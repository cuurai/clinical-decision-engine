...
export class DaoMedicationOrderRepository implements MedicationOrderRepository {
  ...
  async create(orgId: OrgId, data: MedicationOrderInput, createdBy?: string): Promise<Timestamps> {
    try {
  ...
  async update(orgId: OrgId, id: string, data: MedicationOrderUpdate, updatedBy?: string): Promise<Timestamps> {
    try {
  ...
  async createMany(orgId: OrgId, items: Array<MedicationOrderInput>): Promise<Timestamps[]> {
    try {
  ...
  async updateMany(orgId: OrgId, updates: Array<{ id: string; data: MedicationOrderUpdate }>): Promise<Timestamps[]> {
    try {
