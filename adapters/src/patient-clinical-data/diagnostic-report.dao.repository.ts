...
export class DaoDiagnosticReportRepository implements DiagnosticReportRepository {
  ...
  async create(orgId: OrgId, data: DiagnosticReportInput, createdBy?: string): Promise<Timestamps> {
    try {
  ...
  async update(orgId: OrgId, id: string, data: DiagnosticReportUpdate, updatedBy?: string): Promise<Timestamps> {
    try {
  ...
  async createMany(orgId: OrgId, items: Array<DiagnosticReportInput>): Promise<Timestamps[]> {
    try {
  ...
  async updateMany(orgId: OrgId, updates: Array<{ id: string; data: DiagnosticReportUpdate }>): Promise<Timestamps[]> {
    try {
