...
import type { EvidenceCitationRepository } from "@cuur-cde/core/knowledge-evidence/repositories/index.js";
import type { UpdateEvidenceCitationRequest } from "@cuur-cde/core/knowledge-evidence/types/index.js";
import type {
    ...
    try {
      ...
      return await this.transactionManager.executeInTransaction(async (tx) => {
        ...
        for (const item of items) {
          const record = await tx.evidenceCitation.create({
            data: {
              ...item,
              orgId,
            },
