...
import type { ModelDefinitionRepository } from "@cuur-cde/core/knowledge-evidence/repositories/index.js";
import type { UpdateModelDefinitionRequest } from "@cuur-cde/core/knowledge-evidence/types/index.js";
import type {
...
export class DaoModelDefinitionRepository implements ModelDefinitionRepository {
  ...
  async list(orgId: OrgId, params?: PaginationParams): Promise<PaginatedResult<ModelDefinition>> {
    try {
    ...
    try {
      ...
      return await this.transactionManager.executeInTransaction(async (tx) => {
        ...
        for (const item of items) {
          const record = await tx.modelDefinition.create({
            data: {
              ...item,
              orgId,
            },
  ...
  async updateMany(
    orgId: OrgId,
    updates: Array<{ id: string; data: ModelDefinitionUpdate }>
  ): Promise<ModelDefinition[]> {
    try {
