...
import type { ThresholdProfileRepository } from "@cuur-cde/core/decision-intelligence/repositories/index.js";
import type {
...
export class DaoThresholdProfileRepository implements ThresholdProfileRepository {
  ...
  async update(
    orgId: OrgId,
    id: string,
    data: UpdateThresholdProfileRequest
  ...
  async updateMany(
    orgId: OrgId,
    updates: Array<{ id: string; data: UpdateThresholdProfileRequest }>
  ): Promise<ThresholdProfile[]> {
    try {
