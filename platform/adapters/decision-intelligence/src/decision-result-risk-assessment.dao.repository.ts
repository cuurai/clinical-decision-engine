/**
 * DAO adapter for DecisionResultRiskAssessmentRepository
 *
...
import type { DecisionResultRiskAssessmentRepository } from "@cuur-cde/core/decision-intelligence/repositories/index.js";
import type { DecisionResultRiskAssessment } from "@cuur-cde/core/decision-intelligence/types/index.js";
...
export class DaoDecisionResultRiskAssessmentRepository
  implements DecisionResultRiskAssessmentRepository
{
  ...
  async get(orgId: OrgId, id: string): Promise<DecisionResultRiskAssessment | null> {
    const result = await this.findById(orgId, id);
    if (!result) {
      throw new NotFoundError("DecisionResultRiskAssessment", id);
    }
    return result;
  }
  private toDomain(model: any): DecisionResultRiskAssessment {
    return {
      ...model,
      ...
      updatedAt:
        model.updatedAt instanceof Date
          ...
          : undefined,
    } as DecisionResultRiskAssessment;
  }
}
