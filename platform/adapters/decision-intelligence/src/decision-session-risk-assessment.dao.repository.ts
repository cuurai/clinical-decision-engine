/**
 * DAO adapter for DecisionSessionRiskAssessmentRepository
 *
...
import type { DecisionSessionRiskAssessmentRepository } from "@cuur-cde/core/decision-intelligence/repositories/index.js";
import type { DecisionSessionRiskAssessment } from "@cuur-cde/core/decision-intelligence/types/index.js";
  ...
  implements DecisionSessionRiskAssessmentRepository
{
  ...
  async get(orgId: OrgId, id: string): Promise<DecisionSessionRiskAssessment | null> {
    const result = await this.findById(orgId, id);
    if (!result) {
      throw new NotFoundError("DecisionSessionRiskAssessment", id);
    }
    return result;
  }
