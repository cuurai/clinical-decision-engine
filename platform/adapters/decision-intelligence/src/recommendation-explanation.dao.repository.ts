/**
 * DAO adapter for RecommendationExplanationRepository
 *
...
import type { RecommendationExplanationRepository } from "@cuur-cde/core/decision-intelligence/repositories/index.js";
import type { RecommendationExplanation } from "@cuur-cde/core/decision-intelligence/types/index.js";
...
export class DaoRecommendationExplanationRepository implements RecommendationExplanationRepository {
  ...
  async get(orgId: OrgId, id: string): Promise<RecommendationExplanation | null> {
    const result = await this.findById(orgId, id);
    if (!result) {
      throw new NotFoundError("RecommendationExplanation", id);
    }
    return result;
  }
