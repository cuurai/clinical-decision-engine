...
export class DaoImmunizationRepository implements ImmunizationRepository {
  ...
  async createMany(orgId: OrgId, items: Array<ImmunizationInput>): Promise<Immunization[]> {
    try {
      ...
      await this.dao.immunization.createMany({
        data: items.map(item => ({
          ...item,
          orgId,
        })),
  ...
  async updateMany(orgId: OrgId, updates: Array<{ id: string; data: ImmunizationUpdate }>): Promise<Immunization[]> {
    try {
