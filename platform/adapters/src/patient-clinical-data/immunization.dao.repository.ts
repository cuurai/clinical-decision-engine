...
export class DaoImmunizationRepository implements ImmunizationRepository {
  ...
  async create(orgId: OrgId, data: ImmunizationInput, createdBy?: string): Promise<Timestamps> {
    try {
  ...
  async update(orgId: OrgId, id: string, data: ImmunizationUpdate, updatedBy?: string): Promise<Timestamps> {
    try {
  ...
  async createMany(orgId: OrgId, items: Array<ImmunizationInput>): Promise<Timestamps[]> {
    try {
  ...
  async updateMany(orgId: OrgId, updates: Array<{ id: string; data: ImmunizationUpdate }>): Promise<Timestamps[]> {
    try {
