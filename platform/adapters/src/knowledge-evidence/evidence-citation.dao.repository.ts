...
import type {
  ...
  UpdateEvidenceCitationRequest,} from "@cuur/core/knowledge-evidence/repositories/index.js";
import type {
...
export class DaoEvidenceCitationRepository implements EvidenceCitationRepository {
  ...
  async update(orgId: OrgId, id: string, data: UpdateEvidenceCitationRequest): Promise<EvidenceCitation> {
    try {
