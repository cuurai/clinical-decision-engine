...
export class DaoModelVersionRepository implements ModelVersionRepository {
  ...
  async create(orgId: OrgId, data: ModelVersionInput, createdBy?: string): Promise<Timestamps> {
    try {
  ...
  async update(orgId: OrgId, id: string, data: ModelVersionUpdate, updatedBy?: string): Promise<Timestamps> {
    try {
  ...
  async createMany(orgId: OrgId, items: Array<ModelVersionInput>): Promise<Timestamps[]> {
    try {
  ...
  async updateMany(orgId: OrgId, updates: Array<{ id: string; data: ModelVersionUpdate }>): Promise<Timestamps[]> {
    try {
