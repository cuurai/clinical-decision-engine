...
export class DaoScoringTemplateRepository implements ScoringTemplateRepository {
  ...
  async create(orgId: OrgId, data: ScoringTemplateInput, createdBy?: string): Promise<Timestamps> {
    try {
  ...
  async update(orgId: OrgId, id: string, data: ScoringTemplateUpdate, updatedBy?: string): Promise<Timestamps> {
    try {
  ...
  async createMany(orgId: OrgId, items: Array<ScoringTemplateInput>): Promise<Timestamps[]> {
    try {
  ...
  async updateMany(orgId: OrgId, updates: Array<{ id: string; data: ScoringTemplateUpdate }>): Promise<Timestamps[]> {
    try {
