...
export class DaoCarePlanRepository implements CarePlanRepository {
  ...
  async create(orgId: OrgId, data: CarePlanInput, createdBy?: string): Promise<Timestamps> {
    try {
  ...
  async update(orgId: OrgId, id: string, data: CarePlanUpdate, updatedBy?: string): Promise<Timestamps> {
    try {
  ...
  async createMany(orgId: OrgId, items: Array<CarePlanInput>): Promise<Timestamps[]> {
    try {
      // Use createMany for better performance
      await this.dao.carePlan.createMany({
        data: items.map(item => ({
          ...item,
          orgId,
        })),
  ...
  async updateMany(orgId: OrgId, updates: Array<{ id: string; data: CarePlanUpdate }>): Promise<Timestamps[]> {
    try {
