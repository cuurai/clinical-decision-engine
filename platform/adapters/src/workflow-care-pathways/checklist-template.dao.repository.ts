...
export class DaoChecklistTemplateRepository implements ChecklistTemplateRepository {
  ...
  async create(orgId: OrgId, data: ChecklistTemplateInput, createdBy?: string): Promise<Timestamps> {
    try {
  ...
  async update(orgId: OrgId, id: string, data: ChecklistTemplateUpdate, updatedBy?: string): Promise<Timestamps> {
    try {
  ...
  async createMany(orgId: OrgId, items: Array<ChecklistTemplateInput>): Promise<Timestamps[]> {
    try {
  ...
  async updateMany(orgId: OrgId, updates: Array<{ id: string; data: ChecklistTemplateUpdate }>): Promise<Timestamps[]> {
    try {
