 ...
 * createCareTeam Handler Tests
 *
 * Maps to: packages/core/src/patient-clinical-data/handlers/care-team.handler/create-care-team.handler.ts
 * Strategy: Mock repositories, handler-centric, business rules focus
 */

import { describe, it, expect, beforeEach, afterEach, vi } from "vitest";
import { createCareTeam as createCareTeamHandler } from "@cuur-cde/core/patient-clinical-data/handlers/index.js";
...
describe("createCareTeam - Business Rules", () => {
  ...
  describe("✅ Happy Path", () => {
    it("should create careteamhandler with valid data", async () => {
      const input = createCareTeamHandler();

      const result = await createCareTeamHandler(
        TEST_ORG_ID,
        input
      );
