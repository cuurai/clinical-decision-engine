 ...
 * deleteNote Handler Tests
 *
 * Maps to: packages/core/src/patient-clinical-data/handlers/note.handler/delete-note.handler.ts
 * Strategy: Mock repositories, handler-centric, business rules focus
 */

import { describe, it, expect, beforeEach, afterEach, vi } from "vitest";
import { deleteNote as deleteNoteHandler } from "@cuur-cde/core/patient-clinical-data/handlers/index.js";

import { seedFaker } from "../../factories/faker-helpers.js";

describe("deleteNote - Business Rules", () => {
