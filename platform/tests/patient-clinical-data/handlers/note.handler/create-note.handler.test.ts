 ...
 * createNote Handler Tests
 *
 * Maps to: packages/core/src/patient-clinical-data/handlers/note.handler/create-note.handler.ts
 * Strategy: Mock repositories, handler-centric, business rules focus
 */

import { describe, it, expect, beforeEach, afterEach, vi } from "vitest";
import { createNote as createNoteHandler } from "@cuur-cde/core/patient-clinical-data/handlers/index.js";
...
describe("createNote - Business Rules", () => {
  ...
  describe("✅ Happy Path", () => {
    it("should create notehandler with valid data", async () => {
      const input = createNoteHandler();
