 ...
 * updateNote Handler Tests
 *
 * Maps to: packages/core/src/patient-clinical-data/handlers/note.handler/update-note.handler.ts
 * Strategy: Mock repositories, handler-centric, business rules focus
 */

import { describe, it, expect, beforeEach, afterEach, vi } from "vitest";
import { updateNote as updateNoteHandler } from "@cuur-cde/core/patient-clinical-data/handlers/index.js";

import { seedFaker } from "../../factories/faker-helpers.js";

describe("updateNote - Business Rules", () => {
