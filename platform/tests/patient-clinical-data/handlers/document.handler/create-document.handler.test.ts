 ...
 * createDocument Handler Tests
 *
 * Maps to: packages/core/src/patient-clinical-data/handlers/document.handler/create-document.handler.ts
 * Strategy: Mock repositories, handler-centric, business rules focus
 */

import { describe, it, expect, beforeEach, afterEach, vi } from "vitest";
import { createDocument as createDocumentHandler } from "@cuur-cde/core/patient-clinical-data/handlers/index.js";

import { seedFaker } from "../../factories/faker-helpers.js";

describe("createDocument - Business Rules", () => {
  ...
  describe("✅ Happy Path", () => {
    it("should create documenthandler with valid data", async () => {
      const input = createDocumentHandler();
