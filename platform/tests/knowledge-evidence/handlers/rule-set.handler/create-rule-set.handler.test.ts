 ...
 * createRuleSet Handler Tests
 *
 * Maps to: packages/core/src/knowledge-evidence/handlers/rule-set.handler/create-rule-set.handler.ts
 * Strategy: Mock repositories, handler-centric, business rules focus
 */

import { describe, it, expect, beforeEach, afterEach, vi } from "vitest";
import { createRuleSet as createRuleSetHandler } from "@cuur-cde/core/knowledge-evidence/handlers/index.js";
...
describe("createRuleSet - Business Rules", () => {
  ...
  describe("✅ Happy Path", () => {
    it("should create rulesethandler with valid data", async () => {
      const input = createRuleSetHandler();

      const result = await createRuleSetHandler(
        TEST_ORG_ID,
        input
      );
