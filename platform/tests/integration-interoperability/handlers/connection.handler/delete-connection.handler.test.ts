 ...
 * deleteConnection Handler Tests
 *
 * Maps to: packages/core/src/integration-interoperability/handlers/connection.handler/delete-connection.handler.ts
 * Strategy: Mock repositories, handler-centric, business rules focus
 */

import { describe, it, expect, beforeEach, afterEach, vi } from "vitest";
import { deleteConnection as deleteConnectionHandler } from "@cuur-cde/core/integration-interoperability/handlers/index.js";

import { seedFaker } from "../../factories/faker-helpers.js";

describe("deleteConnection - Business Rules", () => {
