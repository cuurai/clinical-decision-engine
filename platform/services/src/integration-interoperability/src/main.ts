...
import {
  ...
  DaoHLMappingProfileRepository,
  DaoHLMappingProfileRuleRepository,
  DaoHLMessageMappingResultRepository,
  DaoHLMessageRepository,
  DaoHLMessageSegmentRepository,
 ...
 */
async function main() {
  console.log("🚀 Starting IntegrationInteroperability Service...");
  ...
  const deps = createDependencies({
    ...
    hLMappingProfileRepo: new DaoHLMappingProfileRepository(daoClient),
    hLMappingProfileRuleRepo: new DaoHLMappingProfileRuleRepository(daoClient),
    hLMessageMappingResultRepo: new DaoHLMessageMappingResultRepository(daoClient),
    hLMessageRepo: new DaoHLMessageRepository(daoClient),
    hLMessageSegmentRepo: new DaoHLMessageSegmentRepository(daoClient),
