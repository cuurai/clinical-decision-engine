...
import type { ListEncounterProceduresResponse } from "@cuur-cde/core/patient-clinical-data/types";
import type { EncounterProcedureRepository } from "@cuur-cde/core/patient-clinical-data/repositories";
...
export async function listEncounterProcedures(
  ...
  } as ListEncounterProceduresResponse;
