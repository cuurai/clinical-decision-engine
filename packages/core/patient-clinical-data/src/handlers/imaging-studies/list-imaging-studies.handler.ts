...
import type { ListImagingStudiesParams, ListImagingStudiesResponse } from "@cuur-cde/core/patient-clinical-data";
...
): Promise<ListImagingStudiesResponse> {
