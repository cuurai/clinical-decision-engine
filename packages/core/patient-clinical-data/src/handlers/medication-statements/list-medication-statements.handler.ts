...
import type { ListMedicationStatementsParams, ListMedicationStatementsResponse } from "@cuur-cde/core/patient-clinical-data/types";
...
export async function listMedicationStatements(
  ...
  } as ListMedicationStatementsResponse;
