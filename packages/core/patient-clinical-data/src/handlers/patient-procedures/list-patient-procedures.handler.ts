...
import type { ListPatientProceduresResponse } from "@cuur-cde/core/patient-clinical-data/types";
import type { PatientProcedureRepository } from "@cuur-cde/core/patient-clinical-data/repositories";
...
export async function listPatientProcedures(
  ...
  } as ListPatientProceduresResponse;
