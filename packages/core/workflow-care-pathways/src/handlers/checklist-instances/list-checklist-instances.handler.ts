...
import type { ListChecklistInstancesParams, ListChecklistInstancesResponse } from "@cuur-cde/core/workflow-care-pathways/types";
...
export async function listChecklistInstances(
  ...
  } as ListChecklistInstancesResponse;
