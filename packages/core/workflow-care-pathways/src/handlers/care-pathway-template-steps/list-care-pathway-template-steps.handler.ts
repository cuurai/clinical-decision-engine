...
import type { ListCarePathwayTemplateStepsResponse } from "@cuur-cde/core/workflow-care-pathways/types";
import type { CarePathwayTemplateStepRepository } from "@cuur-cde/core/workflow-care-pathways/repositories";
...
export async function listCarePathwayTemplateSteps(
  ...
  } as ListCarePathwayTemplateStepsResponse;
