...
import type { ListInterfaceHealthChecksParams, ListInterfaceHealthChecksResponse } from "@cuur-cde/core/integration-interoperability/types";
...
export async function listInterfaceHealthChecks(
  ...
  } as ListInterfaceHealthChecksResponse;
