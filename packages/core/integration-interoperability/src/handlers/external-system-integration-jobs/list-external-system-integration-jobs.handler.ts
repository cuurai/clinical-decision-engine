...
import type { ListExternalSystemIntegrationJobsResponse } from "@cuur-cde/core/integration-interoperability/types";
import type { ExternalSystemIntegrationJobRepository } from "@cuur-cde/core/integration-interoperability/repositories";
...
export async function listExternalSystemIntegrationJobs(
  ...
  } as ListExternalSystemIntegrationJobsResponse;
