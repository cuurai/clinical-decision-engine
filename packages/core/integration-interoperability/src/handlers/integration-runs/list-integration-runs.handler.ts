...
import type { ListIntegrationRunsParams, ListIntegrationRunsResponse } from "@cuur-cde/core/integration-interoperability/types";
...
export async function listIntegrationRuns(
...
): Promise<ListIntegrationRunsResponse> {
  ...
  } as ListIntegrationRunsResponse;
