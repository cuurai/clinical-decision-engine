...
import type { ListFHIRMappingProfilesParams, ListFHIRMappingProfilesResponse } from "@cuur-cde/core/integration-interoperability";
...
export async function listFHIRMappingProfiles(
  ...
  } as ListFHIRMappingProfilesResponse;
