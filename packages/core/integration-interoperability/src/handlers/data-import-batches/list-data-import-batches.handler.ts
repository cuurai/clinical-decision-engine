...
import type { ListDataImportBatchesParams, ListDataImportBatchesResponse } from "@cuur-cde/core/integration-interoperability/types";
...
export async function listDataImportBatches(
...
): Promise<ListDataImportBatchesResponse> {
  ...
  } as ListDataImportBatchesResponse;
