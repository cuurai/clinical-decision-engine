...
import type { ListEventDeliveriesParams, ListEventDeliveriesResponse } from "@cuur-cde/core/integration-interoperability/types";
import type { EventDeliveryRepository } from "@cuur-cde/core/integration-interoperability/repositories";
...
export async function listEventDeliveries(
  ...
  } as ListEventDeliveriesResponse;
