...
import type { ListDataExportBatchesParams, ListDataExportBatchesResponse } from "@cuur-cde/core/integration-interoperability/types";
...
export async function listDataExportBatches(
  ...
  } as ListDataExportBatchesResponse;
