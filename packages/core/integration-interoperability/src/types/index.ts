...
export type CreateExternalSystemInput = NonNullable<
  operations["createExternalSystem"]["requestBody"]
>["content"]["application/json"];
export type UpdateExternalSystemInput = NonNullable<
  operations["updateExternalSystem"]["requestBody"]
>["content"]["application/json"];
export type CreateConnectionInput = NonNullable<
  operations["createConnection"]["requestBody"]
>["content"]["application/json"];
export type UpdateConnectionInput = NonNullable<
...
>["content"]["application/json"];
export type CreateFHIRMappingProfileInput = NonNullable<
  operations["createFHIRMappingProfile"]["requestBody"]
>["content"]["application/json"];
export type UpdateFHIRMappingProfileInput = NonNullable<
  operations["updateFHIRMappingProfile"]["requestBody"]
>["content"]["application/json"];
export type CreateHLMessageInput = NonNullable<
  operations["createHL7Message"]["requestBody"]
>["content"]["application/json"];
export type CreateHLMappingProfileInput = NonNullable<
  operations["createHL7MappingProfile"]["requestBody"]
>["content"]["application/json"];
export type UpdateHLMappingProfileInput = NonNullable<
  operations["updateHL7MappingProfile"]["requestBody"]
>["content"]["application/json"];
export type CreateIntegrationJobInput = NonNullable<
  operations["createIntegrationJob"]["requestBody"]
>["content"]["application/json"];
export type UpdateIntegrationJobInput = NonNullable<
  operations["updateIntegrationJob"]["requestBody"]
>["content"]["application/json"];
export type CreateIntegrationRunInput = NonNullable<
  operations["createIntegrationRun"]["requestBody"]
>["content"]["application/json"];
export type CreateDataImportBatchInput = NonNullable<
  operations["createDataImportBatch"]["requestBody"]
>["content"]["application/json"];
export type UpdateDataImportBatchInput = NonNullable<
  operations["updateDataImportBatch"]["requestBody"]
>["content"]["application/json"];
export type CreateDataExportBatchInput = NonNullable<
  operations["createDataExportBatch"]["requestBody"]
>["content"]["application/json"];
export type UpdateDataExportBatchInput = NonNullable<
  operations["updateDataExportBatch"]["requestBody"]
>["content"]["application/json"];
export type CreateEventSubscriptionInput = NonNullable<
  operations["createEventSubscription"]["requestBody"]
>["content"]["application/json"];
export type UpdateEventSubscriptionInput = NonNullable<
  operations["updateEventSubscription"]["requestBody"]
>["content"]["application/json"];
export type CreateEventDeliveryInput = NonNullable<
  operations["createEventDelivery"]["requestBody"]
>["content"]["application/json"];
export type UpdateEventDeliveryInput = NonNullable<
  operations["updateEventDelivery"]["requestBody"]
>["content"]["application/json"];
export type CreateAPIClientInput = NonNullable<
  operations["createAPIClient"]["requestBody"]
>["content"]["application/json"];
export type UpdateAPIClientInput = NonNullable<
  operations["updateAPIClient"]["requestBody"]
>["content"]["application/json"];
export type CreateAPICredentialInput = NonNullable<
  operations["createAPICredential"]["requestBody"]
>["content"]["application/json"];
export type UpdateAPICredentialInput = NonNullable<
  operations["updateAPICredential"]["requestBody"]
>["content"]["application/json"];
export type CreateInterfaceErrorInput = NonNullable<
  operations["createInterfaceError"]["requestBody"]
>["content"]["application/json"];
export type UpdateInterfaceErrorInput = NonNullable<
  operations["updateInterfaceError"]["requestBody"]
>["content"]["application/json"];
export type CreateInterfaceHealthCheckInput = NonNullable<
...
export type UpdateAPIClientRequest = UpdateAPIClientInput;
export type UpdateAPICredentialRequest = UpdateAPICredentialInput;
export type UpdateConnectionRequest = UpdateConnectionInput;
export type UpdateDataExportBatchRequest = UpdateDataExportBatchInput;
export type UpdateDataImportBatchRequest = UpdateDataImportBatchInput;
export type UpdateEventDeliveryRequest = UpdateEventDeliveryInput;
export type UpdateEventSubscriptionRequest = UpdateEventSubscriptionInput;
export type UpdateExternalSystemRequest = UpdateExternalSystemInput;
export type UpdateFHIRMappingProfileRequest = UpdateFHIRMappingProfileInput;
export type UpdateHL7MappingProfileRequest = UpdateHLMappingProfileInput;
export type UpdateIntegrationJobRequest = UpdateIntegrationJobInput;
export type UpdateInterfaceErrorRequest = UpdateInterfaceErrorInput;
