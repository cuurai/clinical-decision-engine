...
import type { ListDecisionRequestsParams, ListDecisionRequestsResponse } from "@cuur-cde/core/decision-intelligence";
...
export async function listDecisionRequests(
    ...
    orgId: string,
    params?: ListDecisionRequestsParams
): Promise<ListDecisionRequestsResponse> {
  ...
  } as ListDecisionRequestsResponse;
