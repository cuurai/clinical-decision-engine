...
import type { ListEvidenceCitationsParams, ListEvidenceCitationsResponse } from "@cuur-cde/core/knowledge-evidence/types";
 ...
 */
export async function listEvidenceCitations(
    repo: EvidenceCitationRepository,
    orgId: string,
    params?: ListEvidenceCitationsParams
): Promise<ListEvidenceCitationsResponse> {
  ...
  } as ListEvidenceCitationsResponse;
