...
import type { ListClinicalRulesParams, ListClinicalRulesResponse } from "@cuur-cde/core/knowledge-evidence/types";
 ...
 * List clinical rules
 */
export async function listClinicalRules(
    repo: ClinicalRuleRepository,
    orgId: string,
    params?: ListClinicalRulesParams
): Promise<ListClinicalRulesResponse> {
