...
import type { ListScoringTemplateItemsResponse } from "@cuur-cde/core/knowledge-evidence/types";
import type { ScoringTemplateItemRepository } from "@cuur-cde/core/knowledge-evidence/repositories";
...
export async function listScoringTemplateItems(
  ...
  } as ListScoringTemplateItemsResponse;
