...
import type { ListEvidenceReviewsParams, ListEvidenceReviewsResponse } from "@cuur-cde/core/knowledge-evidence/types";
...
export async function listEvidenceReviews(
...
): Promise<ListEvidenceReviewsResponse> {
  ...
  } as ListEvidenceReviewsResponse;
