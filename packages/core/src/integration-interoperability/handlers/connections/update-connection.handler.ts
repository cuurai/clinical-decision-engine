...
import type { ConnectionUpdate, UpdateConnectionResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: ConnectionUpdate): ConnectionUpdate {
