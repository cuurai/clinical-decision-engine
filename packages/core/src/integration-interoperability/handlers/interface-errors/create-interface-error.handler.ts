...
import type { CreateInterfaceErrorResponse, InterfaceErrorInput } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: InterfaceErrorInput): InterfaceErrorInput {
