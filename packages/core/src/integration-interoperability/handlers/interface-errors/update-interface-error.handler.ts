...
import type { InterfaceErrorUpdate, UpdateInterfaceErrorResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: InterfaceErrorUpdate): InterfaceErrorUpdate {
