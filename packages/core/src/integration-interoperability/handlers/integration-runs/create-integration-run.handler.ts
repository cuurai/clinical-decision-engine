...
import type { CreateIntegrationRunResponse, IntegrationRunInput } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: IntegrationRunInput): IntegrationRunInput {
