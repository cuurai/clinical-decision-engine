...
import type { CreateEventDeliveryResponse, EventDeliveryInput } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: EventDeliveryInput): EventDeliveryInput {
