...
import type { EventDeliveryUpdate, UpdateEventDeliveryResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: EventDeliveryUpdate): EventDeliveryUpdate {
