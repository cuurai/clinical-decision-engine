...
import type { APIClientInput, CreateAPIClientResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: APIClientInput): APIClientInput {
