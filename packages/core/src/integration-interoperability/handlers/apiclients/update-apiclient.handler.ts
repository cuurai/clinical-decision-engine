...
import type { APIClientUpdate, UpdateAPIClientResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: APIClientUpdate): APIClientUpdate {
