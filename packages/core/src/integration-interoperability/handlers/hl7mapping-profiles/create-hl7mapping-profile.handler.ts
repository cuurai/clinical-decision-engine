...
import type { CreateHLMappingProfileResponse, HL7MappingProfileInput } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: HL7MappingProfileInput): HL7MappingProfileInput {
