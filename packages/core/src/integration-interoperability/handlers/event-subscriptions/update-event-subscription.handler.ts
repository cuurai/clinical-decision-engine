...
import type { EventSubscriptionUpdate, UpdateEventSubscriptionResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: EventSubscriptionUpdate): EventSubscriptionUpdate {
...
export async function updateEventSubscription(
    ...
    _input: EventSubscriptionUpdate
