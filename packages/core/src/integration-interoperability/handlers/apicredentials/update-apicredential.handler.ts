...
import type { APICredentialUpdate, UpdateAPICredentialResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: APICredentialUpdate): APICredentialUpdate {
