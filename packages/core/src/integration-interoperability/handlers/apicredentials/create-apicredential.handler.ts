...
import type { APICredentialInput, CreateAPICredentialResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: APICredentialInput): APICredentialInput {
