...
import type { FHIRMappingProfileUpdate, UpdateFHIRMappingProfileResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: FHIRMappingProfileUpdate): FHIRMappingProfileUpdate {
...
export async function updateFHIRMappingProfile(
    ...
    _input: FHIRMappingProfileUpdate
