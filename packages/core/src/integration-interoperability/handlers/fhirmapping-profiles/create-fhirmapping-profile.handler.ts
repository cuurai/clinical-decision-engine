...
import type { CreateFHIRMappingProfileResponse, FHIRMappingProfileInput } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: FHIRMappingProfileInput): FHIRMappingProfileInput {
...
export async function createFHIRMappingProfile(
    ...
    _input: FHIRMappingProfileInput
