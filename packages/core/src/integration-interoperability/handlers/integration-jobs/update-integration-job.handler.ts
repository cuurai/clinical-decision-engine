...
import type { IntegrationJobUpdate, UpdateIntegrationJobResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: IntegrationJobUpdate): IntegrationJobUpdate {
