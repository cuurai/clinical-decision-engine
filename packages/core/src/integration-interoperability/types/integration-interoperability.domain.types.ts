...
export type ExternalSystemInputInput = NonNullable<operations["createExternalSystem"]["requestBody"]>["content"]["application/json"];
export type ExternalSystemUpdateInput = NonNullable<operations["updateExternalSystem"]["requestBody"]>["content"]["application/json"];
export type ConnectionInputInput = NonNullable<operations["createConnection"]["requestBody"]>["content"]["application/json"];
export type ConnectionUpdateInput = NonNullable<operations["updateConnection"]["requestBody"]>["content"]["application/json"];
export type FHIRBundleInputInput = NonNullable<operations["createFHIRBundle"]["requestBody"]>["content"]["application/json"];
export type FHIRMappingProfileInputInput = NonNullable<operations["createFHIRMappingProfile"]["requestBody"]>["content"]["application/json"];
export type FHIRMappingProfileUpdateInput = NonNullable<operations["updateFHIRMappingProfile"]["requestBody"]>["content"]["application/json"];
export type HL7MessageInputInput = NonNullable<operations["createHL7Message"]["requestBody"]>["content"]["application/json"];
export type HL7MappingProfileInputInput = NonNullable<operations["createHL7MappingProfile"]["requestBody"]>["content"]["application/json"];
export type HL7MappingProfileUpdateInput = NonNullable<operations["updateHL7MappingProfile"]["requestBody"]>["content"]["application/json"];
export type IntegrationJobInputInput = NonNullable<operations["createIntegrationJob"]["requestBody"]>["content"]["application/json"];
export type IntegrationJobUpdateInput = NonNullable<operations["updateIntegrationJob"]["requestBody"]>["content"]["application/json"];
export type IntegrationRunInputInput = NonNullable<operations["createIntegrationRun"]["requestBody"]>["content"]["application/json"];
export type DataImportBatchInputInput = NonNullable<operations["createDataImportBatch"]["requestBody"]>["content"]["application/json"];
export type DataImportBatchUpdateInput = NonNullable<operations["updateDataImportBatch"]["requestBody"]>["content"]["application/json"];
export type DataExportBatchInputInput = NonNullable<operations["createDataExportBatch"]["requestBody"]>["content"]["application/json"];
export type DataExportBatchUpdateInput = NonNullable<operations["updateDataExportBatch"]["requestBody"]>["content"]["application/json"];
export type EventSubscriptionInputInput = NonNullable<operations["createEventSubscription"]["requestBody"]>["content"]["application/json"];
export type EventSubscriptionUpdateInput = NonNullable<operations["updateEventSubscription"]["requestBody"]>["content"]["application/json"];
export type EventDeliveryInputInput = NonNullable<operations["createEventDelivery"]["requestBody"]>["content"]["application/json"];
export type EventDeliveryUpdateInput = NonNullable<operations["updateEventDelivery"]["requestBody"]>["content"]["application/json"];
export type APIClientInputInput = NonNullable<operations["createAPIClient"]["requestBody"]>["content"]["application/json"];
export type APIClientUpdateInput = NonNullable<operations["updateAPIClient"]["requestBody"]>["content"]["application/json"];
export type APICredentialInputInput = NonNullable<operations["createAPICredential"]["requestBody"]>["content"]["application/json"];
export type APICredentialUpdateInput = NonNullable<operations["updateAPICredential"]["requestBody"]>["content"]["application/json"];
export type InterfaceErrorInputInput = NonNullable<operations["createInterfaceError"]["requestBody"]>["content"]["application/json"];
export type InterfaceErrorUpdateInput = NonNullable<operations["updateInterfaceError"]["requestBody"]>["content"]["application/json"];
export type InterfaceHealthCheckInputInput = NonNullable<operations["createInterfaceHealthCheck"]["requestBody"]>["content"]["application/json"];
