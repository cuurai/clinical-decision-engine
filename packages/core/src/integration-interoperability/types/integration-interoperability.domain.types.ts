...
import type { ApiResponse, ApiListResponse } from "../../shared/types/index.js";
...
// Override response types to ensure they match handler return structure
// All responses are wrapped in { data, meta } envelope

// Single-item responses
export type ListExternalSystemsResponse = ApiListResponse<ExternalSystem>;
export type CreateExternalSystemResponse = ApiResponse<ExternalSystem>;
export type GetExternalSystemResponse = ApiResponse<ExternalSystem>;
export type UpdateExternalSystemResponse = ApiResponse<ExternalSystem>;

export type ListConnectionsResponse = ApiListResponse<Connection>;
export type CreateConnectionResponse = ApiResponse<Connection>;
export type GetConnectionResponse = ApiResponse<Connection>;
export type UpdateConnectionResponse = ApiResponse<Connection>;

export type ListFHIRBundlesResponse = ApiListResponse<FHIRBundle>;
export type GetFHIRBundleResponse = ApiResponse<FHIRBundle>;
export type CreateFHIRBundleResponse = ApiResponse<FHIRBundle>;

export type ListFHIRMappingProfilesResponse = ApiListResponse<FHIRMappingProfile>;
export type GetFHIRMappingProfileResponse = ApiResponse<FHIRMappingProfile>;
export type CreateFHIRMappingProfileResponse = ApiResponse<FHIRMappingProfile>;
export type UpdateFHIRMappingProfileResponse = ApiResponse<FHIRMappingProfile>;

export type ListHLMessagesResponse = ApiListResponse<HL7Message>;
export type GetHLMessageResponse = ApiResponse<HL7Message>;
export type CreateHLMessageResponse = ApiResponse<HL7Message>;

export type ListHLMappingProfilesResponse = ApiListResponse<HL7MappingProfile>;
export type GetHLMappingProfileResponse = ApiResponse<HL7MappingProfile>;
export type CreateHLMappingProfileResponse = ApiResponse<HL7MappingProfile>;
export type UpdateHLMappingProfileResponse = ApiResponse<HL7MappingProfile>;

export type ListIntegrationJobsResponse = ApiListResponse<IntegrationJob>;
export type GetIntegrationJobResponse = ApiResponse<IntegrationJob>;
export type CreateIntegrationJobResponse = ApiResponse<IntegrationJob>;
export type UpdateIntegrationJobResponse = ApiResponse<IntegrationJob>;

export type ListIntegrationRunsResponse = ApiListResponse<IntegrationRun>;
export type GetIntegrationRunResponse = ApiResponse<IntegrationRun>;
export type CreateIntegrationRunResponse = ApiResponse<IntegrationRun>;

export type ListDataImportBatchesResponse = ApiListResponse<DataImportBatch>;
export type GetDataImportBatchResponse = ApiResponse<DataImportBatch>;
export type CreateDataImportBatchResponse = ApiResponse<DataImportBatch>;
export type UpdateDataImportBatchResponse = ApiResponse<DataImportBatch>;

export type ListDataExportBatchesResponse = ApiListResponse<DataExportBatch>;
export type GetDataExportBatchResponse = ApiResponse<DataExportBatch>;
export type CreateDataExportBatchResponse = ApiResponse<DataExportBatch>;
export type UpdateDataExportBatchResponse = ApiResponse<DataExportBatch>;

export type ListEventSubscriptionsResponse = ApiListResponse<EventSubscription>;
export type GetEventSubscriptionResponse = ApiResponse<EventSubscription>;
export type CreateEventSubscriptionResponse = ApiResponse<EventSubscription>;
export type UpdateEventSubscriptionResponse = ApiResponse<EventSubscription>;

export type ListEventDeliveriesResponse = ApiListResponse<EventDelivery>;
export type GetEventDeliveryResponse = ApiResponse<EventDelivery>;
export type CreateEventDeliveryResponse = ApiResponse<EventDelivery>;
export type UpdateEventDeliveryResponse = ApiResponse<EventDelivery>;

export type ListAPIClientsResponse = ApiListResponse<APIClient>;
export type GetAPIClientResponse = ApiResponse<APIClient>;
export type CreateAPIClientResponse = ApiResponse<APIClient>;
export type UpdateAPIClientResponse = ApiResponse<APIClient>;

export type ListAPICredentialsResponse = ApiListResponse<APICredential>;
export type GetAPICredentialResponse = ApiResponse<APICredential>;
export type CreateAPICredentialResponse = ApiResponse<APICredential>;
export type UpdateAPICredentialResponse = ApiResponse<APICredential>;

// InterfaceError not exported from components - define inline if needed
// export type ListInterfaceErrorsResponse = ApiListResponse<InterfaceError>;
// export type GetInterfaceErrorResponse = ApiResponse<InterfaceError>;
// export type CreateInterfaceErrorResponse = ApiResponse<InterfaceError>;
// export type UpdateInterfaceErrorResponse = ApiResponse<InterfaceError>;

export type ListInterfaceHealthChecksResponse = ApiListResponse<InterfaceHealthCheck>;
export type GetInterfaceHealthCheckResponse = ApiResponse<InterfaceHealthCheck>;
export type CreateInterfaceHealthCheckResponse = ApiResponse<InterfaceHealthCheck>;

// Deprecated wrapped type aliases (kept for backward compatibility)
export type ListExternalSystemsResponseWrapped = ApiListResponse<ExternalSystem>;
export type GetExternalSystemResponseWrapped = ApiResponse<ExternalSystem>;
export type CreateExternalSystemResponseWrapped = ApiResponse<ExternalSystem>;
export type UpdateExternalSystemResponseWrapped = ApiResponse<ExternalSystem>;

export type ListConnectionsResponseWrapped = ApiListResponse<Connection>;
export type GetConnectionResponseWrapped = ApiResponse<Connection>;
export type CreateConnectionResponseWrapped = ApiResponse<Connection>;
export type UpdateConnectionResponseWrapped = ApiResponse<Connection>;

export type ListFHIRBundlesResponseWrapped = ApiListResponse<FHIRBundle>;
export type GetFHIRBundleResponseWrapped = ApiResponse<FHIRBundle>;
export type CreateFHIRBundleResponseWrapped = ApiResponse<FHIRBundle>;

export type ListFHIRMappingProfilesResponseWrapped = ApiListResponse<FHIRMappingProfile>;
export type GetFHIRMappingProfileResponseWrapped = ApiResponse<FHIRMappingProfile>;
export type CreateFHIRMappingProfileResponseWrapped = ApiResponse<FHIRMappingProfile>;
export type UpdateFHIRMappingProfileResponseWrapped = ApiResponse<FHIRMappingProfile>;

export type ListHLMessagesResponseWrapped = ApiListResponse<HL7Message>;
export type GetHLMessageResponseWrapped = ApiResponse<HL7Message>;
export type CreateHLMessageResponseWrapped = ApiResponse<HL7Message>;

export type ListHLMappingProfilesResponseWrapped = ApiListResponse<HL7MappingProfile>;
export type GetHLMappingProfileResponseWrapped = ApiResponse<HL7MappingProfile>;
export type CreateHLMappingProfileResponseWrapped = ApiResponse<HL7MappingProfile>;
export type UpdateHLMappingProfileResponseWrapped = ApiResponse<HL7MappingProfile>;

export type ListIntegrationJobsResponseWrapped = ApiListResponse<IntegrationJob>;
export type GetIntegrationJobResponseWrapped = ApiResponse<IntegrationJob>;
export type CreateIntegrationJobResponseWrapped = ApiResponse<IntegrationJob>;
export type UpdateIntegrationJobResponseWrapped = ApiResponse<IntegrationJob>;

export type ListIntegrationRunsResponseWrapped = ApiListResponse<IntegrationRun>;
export type GetIntegrationRunResponseWrapped = ApiResponse<IntegrationRun>;
export type CreateIntegrationRunResponseWrapped = ApiResponse<IntegrationRun>;

export type ListDataImportBatchesResponseWrapped = ApiListResponse<DataImportBatch>;
export type GetDataImportBatchResponseWrapped = ApiResponse<DataImportBatch>;
export type CreateDataImportBatchResponseWrapped = ApiResponse<DataImportBatch>;
export type UpdateDataImportBatchResponseWrapped = ApiResponse<DataImportBatch>;

export type ListDataExportBatchesResponseWrapped = ApiListResponse<DataExportBatch>;
export type GetDataExportBatchResponseWrapped = ApiResponse<DataExportBatch>;
export type CreateDataExportBatchResponseWrapped = ApiResponse<DataExportBatch>;
export type UpdateDataExportBatchResponseWrapped = ApiResponse<DataExportBatch>;

export type ListEventSubscriptionsResponseWrapped = ApiListResponse<EventSubscription>;
export type GetEventSubscriptionResponseWrapped = ApiResponse<EventSubscription>;
export type CreateEventSubscriptionResponseWrapped = ApiResponse<EventSubscription>;
export type UpdateEventSubscriptionResponseWrapped = ApiResponse<EventSubscription>;

export type ListEventDeliveriesResponseWrapped = ApiListResponse<EventDelivery>;
export type GetEventDeliveryResponseWrapped = ApiResponse<EventDelivery>;
export type CreateEventDeliveryResponseWrapped = ApiResponse<EventDelivery>;
export type UpdateEventDeliveryResponseWrapped = ApiResponse<EventDelivery>;

export type ListAPIClientsResponseWrapped = ApiListResponse<APIClient>;
export type GetAPIClientResponseWrapped = ApiResponse<APIClient>;
export type CreateAPIClientResponseWrapped = ApiResponse<APIClient>;
export type UpdateAPIClientResponseWrapped = ApiResponse<APIClient>;

export type ListAPICredentialsResponseWrapped = ApiListResponse<APICredential>;
export type GetAPICredentialResponseWrapped = ApiResponse<APICredential>;
export type CreateAPICredentialResponseWrapped = ApiResponse<APICredential>;
export type UpdateAPICredentialResponseWrapped = ApiResponse<APICredential>;

export type ListInterfaceHealthChecksResponseWrapped = ApiListResponse<InterfaceHealthCheck>;
export type GetInterfaceHealthCheckResponseWrapped = ApiResponse<InterfaceHealthCheck>;
export type CreateInterfaceHealthCheckResponseWrapped = ApiResponse<InterfaceHealthCheck>;
