...
import type { CreateThresholdProfileResponse, ThresholdProfileInput } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: ThresholdProfileInput): ThresholdProfileInput {
