...
import type { ThresholdProfileUpdate, UpdateThresholdProfileResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: ThresholdProfileUpdate): ThresholdProfileUpdate {
