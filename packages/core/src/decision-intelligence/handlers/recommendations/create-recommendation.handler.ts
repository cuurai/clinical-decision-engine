...
import type { CreateRecommendationResponse, RecommendationInput } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: RecommendationInput): RecommendationInput {
