...
import type { ExperimentUpdate, UpdateExperimentResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: ExperimentUpdate): ExperimentUpdate {
