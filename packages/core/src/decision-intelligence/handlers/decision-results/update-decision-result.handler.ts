...
import type { DecisionResultUpdate, UpdateDecisionResultResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: DecisionResultUpdate): DecisionResultUpdate {
