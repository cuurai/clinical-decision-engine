...
import type { CreateDecisionResultResponse, DecisionResultInput } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: DecisionResultInput): DecisionResultInput {
