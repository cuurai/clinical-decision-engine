...
import type { CreateDecisionSessionResponse, DecisionSessionInput } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: DecisionSessionInput): DecisionSessionInput {
