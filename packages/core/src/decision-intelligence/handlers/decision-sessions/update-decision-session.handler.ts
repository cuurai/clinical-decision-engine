...
import type { DecisionSessionUpdate, UpdateDecisionSessionResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: DecisionSessionUpdate): DecisionSessionUpdate {
