...
import type { CreateSimulationRunResponse, SimulationRunInput } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: SimulationRunInput): SimulationRunInput {
