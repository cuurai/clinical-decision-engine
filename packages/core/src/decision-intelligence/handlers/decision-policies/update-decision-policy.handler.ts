...
import type { DecisionPolicyUpdate, UpdateDecisionPolicyResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: DecisionPolicyUpdate): DecisionPolicyUpdate {
