...
import type { CreateExplanationResponse, ExplanationInput } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: ExplanationInput): ExplanationInput {
