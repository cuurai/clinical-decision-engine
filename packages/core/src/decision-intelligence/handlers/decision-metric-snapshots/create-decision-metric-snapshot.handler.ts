...
import type { CreateDecisionMetricSnapshotResponse, DecisionMetricSnapshotInput } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: DecisionMetricSnapshotInput): DecisionMetricSnapshotInput {
...
export async function createDecisionMetricSnapshot(
    ...
    _input: DecisionMetricSnapshotInput
