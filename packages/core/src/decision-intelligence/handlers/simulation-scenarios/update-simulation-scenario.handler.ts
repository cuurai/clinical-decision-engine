...
import type { SimulationScenarioUpdate, UpdateSimulationScenarioResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: SimulationScenarioUpdate): SimulationScenarioUpdate {
...
export async function updateSimulationScenario(
    ...
    _input: SimulationScenarioUpdate
