...
import type { CreateDecisionRequestResponse, DecisionRequestInput } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: DecisionRequestInput): DecisionRequestInput {
