...
import type { CreateEvidenceReviewResponse, EvidenceReviewInput } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: EvidenceReviewInput): EvidenceReviewInput {
