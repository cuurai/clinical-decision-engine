...
import type { EvidenceReviewUpdate, UpdateEvidenceReviewResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: EvidenceReviewUpdate): EvidenceReviewUpdate {
