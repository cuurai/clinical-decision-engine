...
import type { CreateKnowledgePackageResponse, KnowledgePackageInput } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: KnowledgePackageInput): KnowledgePackageInput {
