...
import type { KnowledgePackageUpdate, UpdateKnowledgePackageResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: KnowledgePackageUpdate): KnowledgePackageUpdate {
