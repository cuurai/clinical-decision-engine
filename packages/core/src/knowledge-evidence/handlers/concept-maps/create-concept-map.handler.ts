...
import type { ConceptMapInput, CreateConceptMapResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: ConceptMapInput): ConceptMapInput {
