...
import type { CareProtocolTemplateUpdate, UpdateCareProtocolResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: CareProtocolTemplateUpdate): CareProtocolTemplateUpdate {
...
export async function updateCareProtocol(
    ...
    _input: CareProtocolTemplateUpdate
