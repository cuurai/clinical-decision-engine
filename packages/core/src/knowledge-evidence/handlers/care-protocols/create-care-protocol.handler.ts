...
import type { CareProtocolTemplateInput, CreateCareProtocolResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: CareProtocolTemplateInput): CareProtocolTemplateInput {
...
export async function createCareProtocol(
    ...
    _input: CareProtocolTemplateInput
