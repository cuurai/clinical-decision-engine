...
import type { QuestionnaireTemplateUpdate, UpdateQuestionnaireTemplateResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: QuestionnaireTemplateUpdate): QuestionnaireTemplateUpdate {
...
export async function updateQuestionnaireTemplate(
    ...
    _input: QuestionnaireTemplateUpdate
