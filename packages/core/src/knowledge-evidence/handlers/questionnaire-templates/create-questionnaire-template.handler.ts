...
import type { CreateQuestionnaireTemplateResponse, QuestionnaireTemplateInput } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: QuestionnaireTemplateInput): QuestionnaireTemplateInput {
...
export async function createQuestionnaireTemplate(
    ...
    _input: QuestionnaireTemplateInput
