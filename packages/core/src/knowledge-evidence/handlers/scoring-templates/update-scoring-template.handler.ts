...
import type { ScoringTemplateUpdate, UpdateScoringTemplateResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: ScoringTemplateUpdate): ScoringTemplateUpdate {
