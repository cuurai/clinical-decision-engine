...
import type { ClinicalRuleUpdate, UpdateClinicalRuleResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: ClinicalRuleUpdate): ClinicalRuleUpdate {
