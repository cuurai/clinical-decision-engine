...
import type { ClinicalRuleInput, CreateClinicalRuleResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: ClinicalRuleInput): ClinicalRuleInput {
 ...
 */
export async function createClinicalRule(
    // TODO: Use orgId when implementing handler logic,
    _orgId: string,
    // TODO: Use input when implementing handler logic,
    _input: ClinicalRuleInput
): Promise<CreateClinicalRuleResponse> {
  // 1. Validate input
