...
import type { EvidenceCitationUpdate, UpdateEvidenceCitationResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: EvidenceCitationUpdate): EvidenceCitationUpdate {
