...
import type { CreateEscalationPolicyResponse, EscalationPolicyInput } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: EscalationPolicyInput): EscalationPolicyInput {
