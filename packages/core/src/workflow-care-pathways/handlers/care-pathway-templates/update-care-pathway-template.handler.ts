...
import type { CarePathwayTemplateUpdate, UpdateCarePathwayTemplateResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: CarePathwayTemplateUpdate): CarePathwayTemplateUpdate {
...
export async function updateCarePathwayTemplate(
    ...
    _input: CarePathwayTemplateUpdate
