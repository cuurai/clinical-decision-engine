...
import type { UpdateWorkQueueResponse, WorkQueueUpdate } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: WorkQueueUpdate): WorkQueueUpdate {
...
export async function updateWorkQueue(
    ...
    _input: WorkQueueUpdate
): Promise<UpdateWorkQueueResponse> {
  // 1. Validate input
