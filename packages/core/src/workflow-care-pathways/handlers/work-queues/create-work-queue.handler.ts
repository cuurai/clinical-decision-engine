...
import type { CreateWorkQueueResponse, WorkQueueInput } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: WorkQueueInput): WorkQueueInput {
