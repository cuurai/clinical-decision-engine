...
import type { ChecklistInstanceUpdate, UpdateChecklistInstanceResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: ChecklistInstanceUpdate): ChecklistInstanceUpdate {
...
export async function updateChecklistInstance(
    ...
    _input: ChecklistInstanceUpdate
