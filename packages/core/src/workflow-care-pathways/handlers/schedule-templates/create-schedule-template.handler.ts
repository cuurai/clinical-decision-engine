...
import type { CreateScheduleTemplateResponse, ScheduleTemplateInput } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: ScheduleTemplateInput): ScheduleTemplateInput {
