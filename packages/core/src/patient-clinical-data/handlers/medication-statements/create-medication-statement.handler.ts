...
import type { CreateMedicationStatementResponse, MedicationStatementInput } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: MedicationStatementInput): MedicationStatementInput {
...
export async function createMedicationStatement(
    ...
    _input: MedicationStatementInput
