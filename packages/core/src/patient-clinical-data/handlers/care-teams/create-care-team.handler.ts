...
import type { CareTeamInput, CreateCareTeamResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: CareTeamInput): CareTeamInput {
...
export async function createCareTeam(
    ...
    _input: CareTeamInput
): Promise<CreateCareTeamResponse> {
  // 1. Validate input
