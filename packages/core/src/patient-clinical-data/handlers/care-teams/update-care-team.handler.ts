...
import type { CareTeamUpdate, UpdateCareTeamResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: CareTeamUpdate): CareTeamUpdate {
