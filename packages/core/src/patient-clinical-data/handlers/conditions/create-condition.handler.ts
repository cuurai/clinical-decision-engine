...
import type { ConditionInput, CreateConditionResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: ConditionInput): ConditionInput {
