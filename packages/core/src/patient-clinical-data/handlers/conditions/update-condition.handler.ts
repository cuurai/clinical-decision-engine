...
import type { ConditionUpdate, UpdateConditionResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: ConditionUpdate): ConditionUpdate {
