...
import type { ProcedureUpdate, UpdateProcedureResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: ProcedureUpdate): ProcedureUpdate {
