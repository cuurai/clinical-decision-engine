...
import type { CreateProcedureResponse, ProcedureInput } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: ProcedureInput): ProcedureInput {
