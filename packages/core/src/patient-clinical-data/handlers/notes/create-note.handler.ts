...
import type { ClinicalNoteInput, CreateNoteResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: ClinicalNoteInput): ClinicalNoteInput {
