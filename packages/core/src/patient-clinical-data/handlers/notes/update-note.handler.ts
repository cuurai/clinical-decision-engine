...
import type { ClinicalNoteUpdate, UpdateNoteResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: ClinicalNoteUpdate): ClinicalNoteUpdate {
