...
import type { ImagingStudyUpdate, UpdateImagingStudyResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: ImagingStudyUpdate): ImagingStudyUpdate {
...
export async function updateImagingStudy(
    ...
    _input: ImagingStudyUpdate
): Promise<UpdateImagingStudyResponse> {
  // 1. Validate input
