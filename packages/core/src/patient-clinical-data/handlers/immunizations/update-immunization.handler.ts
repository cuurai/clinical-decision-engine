...
import type { ImmunizationUpdate, UpdateImmunizationResponse } from "../../types/index.js";
 ...
 */
// function mapInputToValidated(input: ImmunizationUpdate): ImmunizationUpdate {
