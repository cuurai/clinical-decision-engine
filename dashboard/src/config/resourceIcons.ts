 ...
 *
 * Maps resource IDs to their corresponding icons.
 * In the future, this will be moved to the database.
 *
 * Icon format: SVG components or emoji strings
 */

import React from "react";

export type ResourceIconType = "svg" | "emoji";
...
// Icon mapping: serviceId -> resourceId -> icon
export const resourceIcons: Record<string, Record<string, ResourceIcon>> = {
  "decision-intelligence": {
    ...
    "decision-session-risk-assessments": {
      type: "svg",
      content: (
        <svg
          width="20"
    ...
    "decision-result-recommendations": {
      type: "svg",
      content: (
        <svg
          width="20"
    ...
    "decision-result-risk-assessments": {
      type: "svg",
      content: (
        <svg
          width="20"
    ...
    guidelines: {
      ...
      content: (
        ...
        >
          ...
          <path d="M6.5 17H20v4H6.5A2.5 2.5 0 0 1 4 19.5v-0A2.5 2.5 0 0 1 6.5 17z"></path>
    ...
    integrations: {
      ...
      content: (
        ...
        >
          ...
          <path d="M5.636 18.364l4.243-4.243m0-4.242L5.636 5.637"></path>
        </svg>
      ),
    },
 ...
 * @returns The resource icon or a default icon
 */
export function getResourceIcon(serviceId: string, resourceId: string): ResourceIcon {
  const serviceIcons = resourceIcons[serviceId];
  if (serviceIcons && serviceIcons[resourceId]) {
    return serviceIcons[resourceId];
  }

  // Default icon (document/grid)
  return {
    type: "svg",
    content: (
      <svg
